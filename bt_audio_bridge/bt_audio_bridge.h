...
class BtAudioBridge : public Component {
 public:
  ...
  void set_current_speaker_sensor(text_sensor::TextSensor *sensor) { this->current_speaker_sensor_ = sensor; }
 ...
 protected:
  ...
  void save_speaker_(const char *name, const char *mac);
  ...
  text_sensor::TextSensor *current_speaker_sensor_{nullptr};
